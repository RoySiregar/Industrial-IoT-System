<template>
  <div class="maintenance-alert-analysis p-4">
    <!-- Filters -->
    ...
    <div class="grid grid-flow-row-dense grid-cols-4 gap-4 mt-8 h-fit">
      <!-- Station 1 -->
      <div class="card bg-base-300 shadow-xl flex flex-col h-fit ">
        <v-chart :option="chartOptionsMorning" class="w-full h-96" />
        <div class="card-body items-center text-center">
          <h2 class="card-title">R1</h2>
      ...
      <div class="card bg-base-300 shadow-xl col-span-3 flex flex-col ">
        <v-chart :option="chartOptionsNight" class="w-full h-96" />
      ...
      <div class="card bg-base-300 shadow-xl flex flex-col  ">
        <v-chart :option="chartOptionsDay" class="w-full h-96" />
        <div class="card-body items-center text-center mt-auto">
          <h2 class="card-title">R2</h2>
          <div class="card-actions">
      ...
      <!-- Mobility Rate Trends -->
      <div class="card bg-base-300 shadow-xl col-span-3 flex flex-col ">
        <v-chart :option="chartOptionsMidnight" class="w-full h-96" />
        <div class="card-body items-center text-center mt-auto">
          <h2 class="card-title">{{$t('Mobility Rate Trends')}}</h2>
          <div class="card-actions">
            <button class="button-info btn btn-dash btn-info"><span
      ...
      <div class="card bg-base-300 shadow-xl flex flex-col h-full ">
        <v-chart :option="chartOptions2Morning" class="w-full h-96" />
        <div class="card-body items-center text-center mt-auto">
          <h2 class="card-title">R3</h2>
          <div class="card-actions">
      ...
      <!-- Mobility Rate Trends -->
      <div class="card bg-base-300 shadow-xl col-span-3 flex flex-col ">
        <v-chart :option="chartOptions2Night" class="w-full h-96" />
        <div class="card-body items-center text-center mt-auto">
          <h2 class="card-title">{{$t('Mobility Rate Trends')}}</h2>
          <div class="card-actions">
            <button class="button-warning btn btn-dash btn-warn"><span
...
<script lang="ts">
  ...
  export default {
    data() {
      return {
        selected: 'Group 1' as string | null,
        selectedGroup: '',
        showDropdown: false,
        selectedShift: '',
        filters: {
        ...
        activeFilters: ['line', 'group', 'date', 'floor'],
        availableFilters: [{
            label: 'Site',
            value: 'site'
          },
        ...
        chartOptionsNight: {
          ...
          xAxis: {
            type: 'category',
            data: ['6/5 00:00', '6/6 12:00', '6/7 30:00', '6/8 50:00', '6/9 24:00', '6/10 00:00', '6/11 00:00',
              '6/12 00:00', '6/13 30:00', '6/14 58:00', '6/15 14:00', '6/16 22:00', '6/17 00:00', '6/18 00:00'
            ],
            axisLabel: {
              color: '#FFFFFF',
              textShadowColor: 'rgba(255, 255, 255, 0.7)',
        ...
        chartOptions2Night: {
          ...
          series: [{
            ...
            showSymbol: true,
            symbolSize: 8,
            data: [49.7, 60.5, 65.3, 37.5, 38.3, 65.8, 75.6, 55.3, 70.9, 85.2, 62.9, 62.3]
          }],
          legend: {
            show: false
          }
